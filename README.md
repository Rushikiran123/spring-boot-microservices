...
<ul style="list-style-type:disc">
  <li>This project is based on Spring Boot Microservices architecture.</li>
...
<b>1 )</b> Clone project `git clone https://github.com/rushikiranadiboina/spring-boot-microservices.git`
...
Rushi Kiran Adiboina is a Full Stack Developer with over 6 years of experience in designing, developing, and supporting scalable enterprise applications. Specializing in Java, Spring Boot, and Microservices architecture, Rushi maintains this project to demonstrate robust backend integration with Kafka, Docker, and cloud-native technologies.
